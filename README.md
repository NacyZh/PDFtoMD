...
PDFtoMD only converts PDF to Markdown. It does not provide RAG, vector databases, paper summaries, chapter detection, metadata JSON, YAML frontmatter, or cloud model calls.
